...
# loading in files
# datadir = "../Data"
sites_with_dup = gpd.read_file("voucher_schools.geojson")
print(len(sites_with_dup))
...
def comp_all_mats(sites, 
    ...
    np.savez("grocery_mat", walk_speed = walk_speed, dists_geod = dists_geod, time_geod = time_geod)
    ...
    np.savez("grocery_mat", walk_speed = walk_speed, dists_walk = dists_walk, time_walk = time_walk)
    ...
    np.savez("grocery_mat", dists_drive = dists_drive, time_drive = time_drive)
